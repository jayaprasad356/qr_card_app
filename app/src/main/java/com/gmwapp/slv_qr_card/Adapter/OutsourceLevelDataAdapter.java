...
public class OutsourceLevelDataAdapter extends RecyclerView.Adapter<OutsourceLevelDataAdapter.ItemViewHolder> {

    private List<LevelIncomeList> levelIncomeDatas;

    // Constructor
    public OutsourceLevelDataAdapter(List<LevelIncomeList> levelIncomeDatas) {
