...
import com.gmwapp.slv_qr_card.Adapter.ReferTargetAdapter;
...
import com.gmwapp.slv_qr_card.model.RefersTargetModel;
        ...
        ApiConfig.RequestToVolley((result, response) -> {
            if (result) {
                try {
                    ...
                    String message = jsonObject.getString(com.gmwapp.slv_qr_card.helper.Constant.MESSAGE);
